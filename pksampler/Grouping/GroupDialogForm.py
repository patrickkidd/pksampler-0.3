...
# Form implementation generated from reading ui file '/home/patrick/pksampler-0.3/pksampler/Grouping/GroupDialogForm.ui'
#
...
class GroupDialogForm(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        if not name:
            self.setName("GroupDialogForm")

        self.setIcon(self.image0)
        self.setModal(1)

        GroupDialogFormLayout = QGridLayout(self,1,1,6,6,"GroupDialogFormLayout")

        self.deleteButton = QPushButton(self,"deleteButton")

        GroupDialogFormLayout.addWidget(self.deleteButton,3,1)

        self.addButton = QPushButton(self,"addButton")

        GroupDialogFormLayout.addWidget(self.addButton,3,0)

        self.cancelButton = QPushButton(self,"cancelButton")

        GroupDialogFormLayout.addWidget(self.cancelButton,3,4)

        self.okButton = QPushButton(self,"okButton")
        self.okButton.setDefault(1)

        GroupDialogFormLayout.addWidget(self.okButton,3,2)

        self.noGroupButton = QPushButton(self,"noGroupButton")

        GroupDialogFormLayout.addWidget(self.noGroupButton,3,3)

        self.groupListBox = QListBox(self,"groupListBox")
        self.groupListBox.setLineWidth(1)
        self.groupListBox.setMargin(0)
        self.groupListBox.setVariableWidth(0)

        GroupDialogFormLayout.addMultiCellWidget(self.groupListBox,1,2,0,2)

        self.hostListBox = QListBox(self,"hostListBox")
        self.hostListBox.setEnabled(0)
        self.hostListBox.setFrameShape(QListBox.Box)
        self.hostListBox.setFrameShadow(QListBox.Plain)
        self.hostListBox.setLineWidth(1)
        self.hostListBox.setVScrollBarMode(QListBox.Auto)

        GroupDialogFormLayout.addMultiCellWidget(self.hostListBox,2,2,3,4)

        self.textLabel2 = QLabel(self,"textLabel2")

        GroupDialogFormLayout.addWidget(self.textLabel2,0,0)

        self.textLabel1 = QLabel(self,"textLabel1")

        GroupDialogFormLayout.addWidget(self.textLabel1,1,3)

        self.languageChange()

        self.resize(QSize(448,325).expandedTo(self.minimumSizeHint()))
        ...
        self.connect(self.groupListBox,SIGNAL("selectionChanged(QListBoxItem*)"),self.slotSelectionChanged)
        self.connect(self.okButton,SIGNAL("clicked()"),self.slotOk)
        self.connect(self.noGroupButton,SIGNAL("clicked()"),self.slotNoGroup)


    def languageChange(self):
        self.setCaption(self.__tr("Group Selector"))
        self.deleteButton.setText(self.__tr("Delete"))
        self.deleteButton.setAccel(QString.null)
        self.addButton.setText(self.__tr("Add"))
        self.addButton.setAccel(QString.null)
        self.cancelButton.setText(self.__tr("Cancel"))
        self.cancelButton.setAccel(QString.null)
        self.okButton.setText(self.__tr("OK"))
        self.okButton.setAccel(QString.null)
        self.noGroupButton.setText(self.__tr("No Group"))
        self.textLabel2.setText(self.__tr("Groups"))
        self.textLabel1.setText(self.__tr("Hosts:"))


    def slotDelete(self):
        print "GroupDialogForm.slotDelete(): Not implemented yet"

    def slotAdd(self):
        print "GroupDialogForm.slotAdd(): Not implemented yet"

    def slotSelectionChanged(self,a0):
        print "GroupDialogForm.slotSelectionChanged(QListBoxItem*): Not implemented yet"

    def slotNoGroup(self):
        print "GroupDialogForm.slotNoGroup(): Not implemented yet"

    def slotOk(self):
        print "GroupDialogForm.slotOk(): Not implemented yet"

    def __tr(self,s,c = None):
        return qApp.translate("GroupDialogForm",s,c)
