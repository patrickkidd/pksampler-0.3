...
# Form implementation generated from reading ui file '/home/patrick/pksampler-0.3/pksampler/Grouping/CategoryForm.ui'
#
# Created: Wed Jun 29 02:39:02 2005
...
image0_data = \
    ...
    "\xcd\x66\x9e\xc7\x79\x33\xcd\x00\x00\x00\x00\x49" \
...
class CategoryForm(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        if not name:
            self.setName("CategoryForm")

        self.setIcon(self.image0)
        self.setModal(1)

        CategoryFormLayout = QVBoxLayout(self,6,6,"CategoryFormLayout")
        ...
        self.buttonGroup.layout().setMargin(6)
        buttonGroupLayout = QVBoxLayout(self.buttonGroup.layout())
        buttonGroupLayout.setAlignment(Qt.AlignTop)

        self.pushButton1 = QPushButton(self.buttonGroup,"pushButton1")
        buttonGroupLayout.addWidget(self.pushButton1)

        self.pushButton2 = QPushButton(self.buttonGroup,"pushButton2")
        buttonGroupLayout.addWidget(self.pushButton2)

        self.pushButton3 = QPushButton(self.buttonGroup,"pushButton3")
        buttonGroupLayout.addWidget(self.pushButton3)

        self.pushButton4 = QPushButton(self.buttonGroup,"pushButton4")
        buttonGroupLayout.addWidget(self.pushButton4)
        CategoryFormLayout.addWidget(self.buttonGroup)

        self.cancelButton = QPushButton(self,"cancelButton")
        CategoryFormLayout.addWidget(self.cancelButton)

        self.languageChange()

        self.resize(QSize(132,208).expandedTo(self.minimumSizeHint()))
        self.clearWState(Qt.WState_Polished)

        self.connect(self.cancelButton,SIGNAL("clicked()"),self.reject)
        self.connect(self.buttonGroup,SIGNAL("clicked(int)"),self.slotAccept)


    def languageChange(self):
        self.setCaption(self.__tr("Select a category"))
        self.buttonGroup.setTitle(self.__tr("Categories"))
        self.pushButton1.setText(self.__tr("Rhythm"))
        self.pushButton2.setText(self.__tr("Ambient"))
        self.pushButton3.setText(self.__tr("Drums"))
        self.pushButton4.setText(self.__tr("Misc"))
        self.cancelButton.setText(self.__tr("Cancel"))


    def slotAccept(self,a0):
        print "CategoryForm.slotAccept(int): Not implemented yet"

    def __tr(self,s,c = None):
        return qApp.translate("CategoryForm",s,c)
