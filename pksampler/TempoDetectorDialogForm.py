...
# Form implementation generated from reading ui file '/home/patrick/pksampler-0.3/pksampler/TempoDetectorDialogForm.ui'
#
...
class TempoDetectorDialogForm(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        if not name:
            self.setName("TempoDetectorDialogForm")

        self.setMinimumSize(QSize(286,102))
        self.setMaximumSize(QSize(286,102))
        pal = QPalette()
        cg = QColorGroup()
        ...
        cg.setColor(QColorGroup.Background,QColor(160,212,255))
        ...
        self.progressBar.setGeometry(QRect(6,73,274,23))
        cg.setColor(QColorGroup.Foreground,Qt.black)
        cg.setColor(QColorGroup.Button,QColor(212,208,200))
        cg.setColor(QColorGroup.Light,Qt.white)
        cg.setColor(QColorGroup.Midlight,QColor(233,231,227))
        ...
        cg.setColor(QColorGroup.ButtonText,Qt.black)
        cg.setColor(QColorGroup.Base,Qt.white)
        cg.setColor(QColorGroup.Background,QColor(181,222,255))
        cg.setColor(QColorGroup.Shadow,Qt.black)
        cg.setColor(QColorGroup.Highlight,QColor(0,0,128))
        cg.setColor(QColorGroup.HighlightedText,Qt.white)
        cg.setColor(QColorGroup.Link,Qt.black)
        ...
        LayoutWidget.setGeometry(QRect(6,42,274,25))
        layout1 = QHBoxLayout(LayoutWidget,6,6,"layout1")

        self.acceptButton = QPushButton(LayoutWidget,"acceptButton")
        self.acceptButton.setEnabled(0)
        self.acceptButton.setDefault(1)
        layout1.addWidget(self.acceptButton)

        self.rejectButton = QPushButton(LayoutWidget,"rejectButton")
        self.rejectButton.setEnabled(0)
        layout1.addWidget(self.rejectButton)

        self.textLabel = QLabel(self,"textLabel")
        self.textLabel.setGeometry(QRect(6,6,190,30))
        self.textLabel.setMinimumSize(QSize(190,30))

        self.multButton = QPushButton(self,"multButton")
        self.multButton.setEnabled(0)
        self.multButton.setGeometry(QRect(200,0,41,41))
        self.multButton.setMinimumSize(QSize(41,41))
        self.multButton.setMaximumSize(QSize(41,41))

        self.divButton = QPushButton(self,"divButton")
        self.divButton.setEnabled(0)
        self.divButton.setGeometry(QRect(240,0,41,41))
        self.divButton.setMinimumSize(QSize(41,41))
        self.divButton.setMaximumSize(QSize(41,41))

        self.languageChange()

        self.resize(QSize(286,102).expandedTo(self.minimumSizeHint()))
        self.clearWState(Qt.WState_Polished)

        self.connect(self.acceptButton,SIGNAL("clicked()"),self.slotAccept)
        self.connect(self.rejectButton,SIGNAL("clicked()"),self.slotReject)
        self.connect(self.divButton,SIGNAL("clicked()"),self.slotDiv2)
        self.connect(self.multButton,SIGNAL("clicked()"),self.slotMult2)


    def languageChange(self):
        self.setCaption(self.__tr("Tempo Detector"))
        self.acceptButton.setText(self.__tr("&Accept"))
        self.rejectButton.setText(self.__tr("&Reject"))
        self.textLabel.setText(self.__tr("Detecting tempo..."))
        self.multButton.setText(self.__tr("x 2"))
        self.divButton.setText(self.__tr("/ 2"))


    def slotAccept(self):
        print "TempoDetectorDialogForm.slotAccept(): Not implemented yet"

    def slotReject(self):
        print "TempoDetectorDialogForm.slotReject(): Not implemented yet"

    def slotDiv2(self):
        print "TempoDetectorDialogForm.slotDiv2(): Not implemented yet"

    def slotMult2(self):
        print "TempoDetectorDialogForm.slotMult2(): Not implemented yet"

    def __tr(self,s,c = None):
        return qApp.translate("TempoDetectorDialogForm",s,c)

if __name__ == "__main__":
    a = QApplication(sys.argv)
    QObject.connect(a,SIGNAL("lastWindowClosed()"),a,SLOT("quit()"))
    w = TempoDetectorDialogForm()
    a.setMainWidget(w)
    w.show()
    a.exec_loop()
